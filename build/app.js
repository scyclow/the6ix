...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hell = __webpack_require__(22);
	
	var _hell2 = _interopRequireDefault(_hell);
	...
	window.onload = function start() {
	  ...
	  game.state.add('hell', _hell2.default);
	  ...
	  (0, _createClass3.default)(Preload, [{
	    ...
	    value: function preload() {
	      ...
	      this.load.onLoadComplete.addOnce(function () {
	        return _this.game.state.start('hell');
	      });
	    }
	  }]);
	  return Preload;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _thing = __webpack_require__(87);
	...
	var Hell = function () {
	  function Hell() {
	    (0, _classCallCheck3.default)(this, Hell);
	  }
	
	  (0, _createClass3.default)(Hell, [{
	    key: 'create',
	    value: function create() {
	      this.physics.startSystem(Phaser.Physics.ARCADE);
	
	      this.background = this.add.sprite(this.world.centerX, this.world.centerY, 'hell');
	
	      this.background.anchor.setTo(0.5, 0.5);
	
	      this.ayeesha = (0, _utils.create)(_character2.default, this.game, 20, 20, 'ayeesha');
	      this.thing = (0, _utils.create)(_thing2.default, this.game, 50, 50, 'ayeesha');
	    }
	  }, {
	    key: 'update',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Character = function (_Phaser$Sprite) {
	  (0, _inherits3.default)(Character, _Phaser$Sprite);
	
	  function Character(game, x, y, name, frame) {
	    (0, _classCallCheck3.default)(this, Character);
	
	    name = name || 'ayeesha';
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Character).call(this, game, x, y, name, frame));
	    ...
	    var baseSpeed = 120;
	    _this.animations.add('walkSideways', [0, 1, 2, 3, 4, 5], 6, true);
	    _this.cursors = game.input.keyboard.createCursorKeys();
	    _this.spaceBar = game.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR);
	
	    _this.speed = baseSpeed;
	    _this.spaceBar.onDown.add(function () {
	      return _this.speed = baseSpeed * 1.5;
	    });
	    _this.spaceBar.onUp.add(function () {
	      return _this.speed = baseSpeed;
	    });
	    return _this;
	  }
	  ...
	  (0, _createClass3.default)(Character, [{
	    ...
	    value: function move() {
	      ...
	      var diagSpeed = Math.sqrt(Math.pow(this.speed, 2) / 2);
	
	      var move = function move(direction) {
	        _this2.scale.x = direction || _this2.scale.x;
...
/***/ function(module, exports) {
	...
	function create(model, game) {
	  for (var _len = arguments.length, args = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
	    args[_key - 2] = arguments[_key];
	  }
	
	  var obj = new (Function.prototype.bind.apply(model, [null].concat([game], args)))();
